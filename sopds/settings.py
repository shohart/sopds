...
CONSTANCE_CONFIG = OrderedDict([
    ...
    ('SOPDS_TELEBOT_PROXY_URL', ('', _('Telegram proxy URL: http://, https://, socks5:// or socks5h://; empty means direct connection.'))),

    ('SOPDS_FLIBUSTA_UPDATE_ENABLED', (False, _('Enable scheduled Flibusta daily archive updates.'))),
    ('SOPDS_FLIBUSTA_SOURCE_URL', ('http://flibusta.is/daily/', _('Flibusta daily archive index URL.'))),
    ('SOPDS_FLIBUSTA_DESTINATION', ('', _('Archive destination; empty uses SOPDS_ROOT_LIB.'))),
    ('SOPDS_FLIBUSTA_FILE_PATTERN', ('*.fb2.*.zip', _('Filename glob for daily archives.'))),
    ('SOPDS_FLIBUSTA_PROXY_URL', ('', _('Flibusta proxy URL: http://, https://, socks5:// or socks5h://; empty means direct connection.'))),
    ('SOPDS_FLIBUSTA_TIMEOUT_SECONDS', (120, _('HTTP timeout in seconds.'))),
    ('SOPDS_FLIBUSTA_RETRIES', (3, _('Download attempts per archive.'))),
    ('SOPDS_FLIBUSTA_MAX_FILE_SIZE_MB', (2048, _('Maximum size of one archive in MiB.'))),
    ('SOPDS_FLIBUSTA_MAX_TOTAL_SIZE_MB', (10240, _('Maximum total staged update size in MiB.'))),
    ('SOPDS_FLIBUSTA_MIN_FREE_SPACE_MB', (2048, _('Minimum free disk space required before each download in MiB.'))),
    ('SOPDS_FLIBUSTA_VALIDATE_ZIP', (True, _('Validate ZIP structure and CRC before publishing.'))),
    ('SOPDS_FLIBUSTA_SCAN_AFTER_UPDATE', (True, _('Run library scanner only after new archives are published successfully.'))),
    ('SOPDS_FLIBUSTA_SHED_MIN', ('0', _('Scheduled update minutes (cron syntax).'))),
    ('SOPDS_FLIBUSTA_SHED_HOUR', ('02', _('Scheduled update hours (cron syntax).'))),
    ('SOPDS_FLIBUSTA_SHED_DAY', ('*', _('Scheduled update day of month (cron syntax).'))),
    ('SOPDS_FLIBUSTA_SHED_DOW', ('*', _('Scheduled update day of week (cron syntax).'))),
    ...
    ('SOPDS_FLIBUSTA_UPDATE_LOG', (os.path.join(BASE_DIR, 'opds_catalog/log/flibusta-update.log'), _('Path to logfile for Flibusta updater.'))),
    ...
    ('SOPDS_SCANNER_LOCK', ('',_('Cross-process scan lock; empty uses <SOPDS_ROOT_LIB>/.sopds-control/scanner.lock.'))),
    ('SOPDS_TELEBOT_PID', (os.path.join(BASE_DIR, 'opds_catalog/tmp/sopds_telebot.pid'), _('Path to pidfile for sopds_telebot process'))),
    ('SOPDS_FLIBUSTA_UPDATE_PID', (os.path.join(BASE_DIR, 'opds_catalog/tmp/flibusta-update.pid'), _('Path to Flibusta updater scheduler PID file.'))),
    ('SOPDS_FLIBUSTA_UPDATE_LOCK', ('', _('Updater lock; empty uses <destination>/.sopds-control/flibusta-update.lock.'))),
    ('SOPDS_FLIBUSTA_UPDATE_STATE', ('', _('Updater state; empty uses <destination>/.sopds-control/flibusta-update-state.json.'))),
...
CONSTANCE_CONFIG_FIELDSETS = {
    ...
    '5. Telegramm Bot Options': ('SOPDS_TELEBOT_API_TOKEN','SOPDS_TELEBOT_AUTH','SOPDS_TELEBOT_MAXITEMS','SOPDS_TELEBOT_PROXY_URL'),
    '6. Flibusta Auto Update': ('SOPDS_FLIBUSTA_UPDATE_ENABLED','SOPDS_FLIBUSTA_SOURCE_URL','SOPDS_FLIBUSTA_DESTINATION','SOPDS_FLIBUSTA_FILE_PATTERN','SOPDS_FLIBUSTA_PROXY_URL','SOPDS_FLIBUSTA_TIMEOUT_SECONDS','SOPDS_FLIBUSTA_RETRIES','SOPDS_FLIBUSTA_MAX_FILE_SIZE_MB','SOPDS_FLIBUSTA_MAX_TOTAL_SIZE_MB','SOPDS_FLIBUSTA_MIN_FREE_SPACE_MB','SOPDS_FLIBUSTA_VALIDATE_ZIP','SOPDS_FLIBUSTA_SCAN_AFTER_UPDATE','SOPDS_FLIBUSTA_SHED_MIN','SOPDS_FLIBUSTA_SHED_HOUR','SOPDS_FLIBUSTA_SHED_DAY','SOPDS_FLIBUSTA_SHED_DOW'),
    '7. Converters Options': ('SOPDS_FB2TOEPUB', 'SOPDS_FB2TOMOBI', 'SOPDS_TEMP_DIR'),
    '8. Log & PID Files': ('SOPDS_SERVER_LOG', 'SOPDS_SCANNER_LOG', 'SOPDS_TELEBOT_LOG','SOPDS_FLIBUSTA_UPDATE_LOG','SOPDS_SERVER_PID','SOPDS_SCANNER_PID','SOPDS_SCANNER_LOCK','SOPDS_TELEBOT_PID','SOPDS_FLIBUSTA_UPDATE_PID','SOPDS_FLIBUSTA_UPDATE_LOCK','SOPDS_FLIBUSTA_UPDATE_STATE'),
}
